...
export const NODE_VOI_MAINNET_HASH: string =
...
export const NODE_VOI_TESTNET_GENESIS_ID: string = "voitest-v1";
export const NODE_VOI_MAINNET_GENESIS_ID: string = "voimain-v1.0";
